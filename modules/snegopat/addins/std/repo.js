...
- load - Строка загрузки аддина. Подстрока `<repo>` заменяется на тип репозитария: либо `<addins>`.
...
var Reposytory = /** @class */ (function () {
    function Reposytory() {
        ...
        new RepoSystem("<Стандартные скрипты>", o.root, "core", env.pathes.addins + "\\std\\", env.pathes.core, "*", true);
