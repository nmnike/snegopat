...
exports.ProfileExchanger = (function () {
    ...
    var Worker = /** @class */ (function () {
        ...
        Worker.prototype.loadHotkeys = function () {
            return profileRoot.getValue(profileKey);
        };
        Worker.prototype.loadPredefHotkeys = function () {
            return profileRoot.getValue(profileAddinsWithKey);
        };
        Worker.prototype.saveHotkeys = function (vt) {
            profileRoot.setValue(profileKey, vt);
        };
        Worker.prototype.savePredefHotkeys = function (map) {
...
function AddHotKey(str, addin, macros) {
    hotkeys.add(exports.KeyCodes.codeFromString(str), addin, macros);
}
...
var PredefinedHotKeyReceiver = /** @class */ (function () {
    ...
    PredefinedHotKeyReceiver.prototype.add = function (macros, hotkey) {
        var pd = { macros: macros, hotkeys: [] };
        var allhk = hotkey.split("|");
        for (var k in allhk) {
            var code = exports.KeyCodes.codeFromString(allhk[k]);
            if (code)
                pd.hotkeys.push(code);
        }
        this.receiver.push(pd);
    };
    PredefinedHotKeyReceiver.prototype.setVersion = function (version) {
...
function registerAddinHotkeys(addin) {
    ...
    var addinsHotKey = exports.ProfileExchanger.loadPredefHotkeys();
    ...
    var existHotKeys = exports.ProfileExchanger.loadHotkeys();
    for (var i in predefHotKeys.receiver) {
        ...
        for (var k in hk.hotkeys) {
            hotKeyStr = exports.KeyCodes.stringFromCode(hk.hotkeys[k]);
        ...
        if (!hotKey) {
            ...
            hotKey = hk.hotkeys[0];
            hotKeyStr = exports.KeyCodes.stringFromCode(hotKey);
            var rowEx = existHotKeys.Найти(hotKeyStr, "СочетаниеКлавиш");
...
var SelectHotKey = /** @class */ (function () {
    ...
    SelectHotKey.prototype.OKНажатие = function () {
