...
Макросы сгруппированы в дерево, в зависимeости от предоставляющих их аддинов.
...
exports.MacrosWnd = (function () {
    var MacrosWnd = /** @class */ (function () {
        function MacrosWnd() {
            ...
            this.pattern = null;
            this.hotkeys = {};
            this.form = loadScriptFormEpf(env.pathes.addins + "\\std\\forms\\sn_forms.epf", "Macroses", this);
